...
export interface components {
  schemas: {
    ...
    Flags: {
       ...
       * @default /stable-diffusion-webui/configs/v1-inference.yaml
       */
      config?: string
      /**
       * Ckpt
       ...
       * @default /stable-diffusion-webui/model.ckpt
       */
      ckpt?: string
      /**
       * Ckpt Dir
       ...
       * @default /stable-diffusion-webui/ui-config.json
       */
       ...
       * @default /stable-diffusion-webui/config.json
       */
       ...
       * @default /stable-diffusion-webui/styles.csv
       */
      styles_file?: string
      /**
       * Autolaunch
    ...
    Options: {
       ...
       * ]
       */
      keyedit_delimiters_whitespace?: unknown[]
      /**
       * Keyedit Move
      ...
      /**
       * Sd Lora
       * @description Add network to prompt
       * @default None
       */
      sd_lora?: string
      /**
       * Lora Preferred Name
       * @description When adding to prompt, refer to Lora by
       * @default Alias from file
       */
      lora_preferred_name?: string
      /**
       * Lora Add Hashes To Infotext
       * @description Add Lora hashes to infotext
       * @default true
       */
      lora_add_hashes_to_infotext?: boolean
      /**
       * Lora Show All
       * @description Always show all networks on the Lora page
       * @default false
       */
      lora_show_all?: unknown
      /**
       * Lora Hide Unknown For Versions
       * @description Hide networks of unknown versions for model versions
       * @default []
       */
      lora_hide_unknown_for_versions?: unknown
      /**
       * Lora In Memory Limit
       * @description Number of Lora networks to keep cached in memory
       * @default 0
       */
      lora_in_memory_limit?: unknown
      /**
       * Lora Functional
       * @description Lora/Networks: use old method that takes longer when you have multiple Loras active and produces same results as kohya-ss/sd-webui-additional-networks extension
       * @default false
       */
      lora_functional?: unknown
      /**
       * Canvas Hotkey Zoom
      ...
      /**
       * Canvas Auto Expand
       * @description Automatically expands an image that does not fit completely in the canvas area, similar to manually pressing the S and R buttons
       * @default true
       */
       ...
       * ]
       */
      canvas_disabled_functions?: unknown[]
      /**
       * Settings In Ui
